...
python -m debugpy --listen 5681 --wait-for-client run_chents.py \
    --model_name $MODEL \
    --task_name $TASK \
    ...
    --quant_method omniquant --clip_zo_grad \
    --omni_ckpt_dir /home/user/Workspace/chents/OmniQuant/pre_quantized_models/opt-1.3b-w4a16 \
    --omni_base_model facebook/opt-1.3b \
    --omni_net opt-1.3b \
    $EXTRA_ARGS \
    $TASK_ARGS \
    "$@"
# you can also set --quant_method to aqlm