...
class Dataset:
    ...
    def sample_train_sets(self, num_train=32, num_dev=None, num_eval=32, num_train_sets=None, seed=None):
        if seed is not None:
        ...
        for i, set_seed in enumerate(seeds):
            if self.mixed_set:
                ...
                if num_dev is not None:
                    ...
                    train_samples.append(self.sample_subset(data_split="train", seed=set_seed, num=num_eval))
