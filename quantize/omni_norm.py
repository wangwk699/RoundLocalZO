...
class OmniLayerNorm(nn.Module):
    def __init__(self, ori_layer_norm) -> None:
        ...
        # ldx:add
        # self.register_parameter('orig_weight', nn.Parameter(ori_layer_norm.weight.clone()))
        # if ori_layer_norm.bias is not None:
        #     self.register_parameter('orig_bias', nn.Parameter(ori_layer_norm.bias.clone()))
        # else:
        #     self.orig_bias = None
        # ldx:add:
        # self.register_parameter('orig_weight', nn.Parameter(ori_layer_norm.weight.clone()))
